...
def load_model():
    #check whether we has gpu or not
    ...
    checkpoint = f"./checkpoints/{YOLO_MODEL_NAMES}"
...
def predict_image(Yolo, image_path, show=False, output_path='', score_threshold=0.3, iou_threshold=0.45):
